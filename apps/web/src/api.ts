...
export function createAgent(
  data: { name: string; systemPrompt: string; hasRagEnabled?: boolean; ragDataStoreId?: string; guardrailEnabled?: boolean; guardrailRules?: string; tracingEnabled?: boolean; tracingUrl?: string; tracingAigatewayId?: string; hasSemanticCache?: boolean; model?: string; temperature?: number },
  token: string,
) {
